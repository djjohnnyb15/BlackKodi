...
def Destroy_Path(path):
    dp.create("[COLOR=white]Shadow Builds[/COLOR]","Wiping...",'', 'Please Wait')
...
def Kill_XBMC():
    dialog.ok('[COLOR=white]Shadow Builds[/COLOR]','The system will now attempt to force close Kodi.','You may encounter a freeze, if that happens give it a minute','and if it doesn\'t close please restart your system.')
